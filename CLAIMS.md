...
|---|---|---|---|
| Group B hand-asm fix: 9 funcs | lunavyqo (Grok) | 2026-07-23 | **active** — 1/9 pure-C MATCH (func_ov002_020bf13c y-early Vec3; linkcheck VERIFIED). Remaining: ov007 div=2, ov009 div=3, ov095 div=35, PMF+68398 floors. No HAND-ASM. | lunavyqo (Grok) | 2026-07-23 | **active** — 0/9 pure-C MATCH after multi-agent grind; best tips banked (ov007 div=2; ov009 div=5; ov002 div=12; ov095 div=35; PMF+68398 floors). No HAND-ASM. branch fix/group-b-hand-asm-to-c | lunavyqo (Grok) | 2026-07-23 | **active** — removed false HAND-ASM from src; pure C tips in nearmiss (ov007 div=3, ov009 div=5); branch fix/group-b-hand-asm-to-c |
