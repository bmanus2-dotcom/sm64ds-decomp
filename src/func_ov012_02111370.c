...
int func_ov012_02111370(char *c)
{
    ...
    if (data_0209caa0[2] & 0x80000) {
        *(int *)(int)(((long long)(int)(c + 0x60)) & 0xffffffffffffffffLL) -= 0x64000;
        *(unsigned char *)(c + 0x31e) = 1;
    }
    _ZN8Platform21UpdateModelPosAndRotYEv(c);
    _ZN8Platform19UpdateClsnPosAndRotEv(c);
    void *kcl = _ZN12MeshCollider8LoadFileER13SharedFilePtr(&data_ov012_021124a0);
    _ZN18MovingMeshCollider7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(c + 0x124, kcl, c + 0x2ec, 0x199, *(short *)(c + 0x8e), (void *)&data_ov012_02111cd0);
    return 1;
}
