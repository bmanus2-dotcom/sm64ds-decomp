...
state1:
    if (self[0x93] != 0) {
        unsigned char *p = (unsigned char *)(((long long)(int)(self + 0x93)) & 0xFFFFFFFFFFFFFFFFLL);
        *p = (unsigned char)(*p - data_0208ee44);
        if (self[0x93] == 0)
            func_ov003_020b0730(self, 0);
    }
    if (self[0x92] != 0) {
        unsigned char *p = (unsigned char *)(((long long)(int)(self + 0x92)) & 0xFFFFFFFFFFFFFFFFLL);
        *p = (unsigned char)(*p - data_0208ee44);
        if (self[0x92] == 0) {
            if (self[0x91] == 0)
                func_0202ae74();
